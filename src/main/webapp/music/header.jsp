...
<div id="header">
	...
	<ul class="header_ul">
		...
		<li><a href="/UserCollectionuserCollection.action?userid=<s:property value="#session.user.userid"/>" class="header_a" onclick="checkUser()">我的音乐</a></li>
...
<div id="header_song">
	<ul>
		...
		<li><a href="/albumall.action?result=before" class="header_a">专辑</a></li>
